...
(function($) {
    "use strict";
		...
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "logo.png");
			jQuery(".footer-logo .text-center img").attr("src", "logo.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "logo2.png");
			jQuery(".footer-logo .text-center img").attr("src", "logo2.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "logo3.png");
			jQuery(".footer-logo .text-center img").attr("src", "logo3.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "logo4.png");
			jQuery(".footer-logo .text-center img").attr("src", "logo4.png");
			return false;
		});
